                                    ...
                                    <td style="width: 50%; padding-left: 0">
                                        <ul>
                                            <li>
                                                ...
                                                <span style="font-size: 10px; ">CPF: <?php echo $result->documento?><br/>
                                                    <span style="font-size: 10px; ">Endereço: <?php echo $result->rua?>
                                                        <span style="font-size: 10px;">, <?php echo $result->numero?>
                                                            <span style="font-size: 10px; "> - <?php echo $result->bairro?>
                                            </li>
                                        </ul>
                                    </td>
