            ...
            <div class="widget-content nopadding">
                ...
                <div class="span12" id="divProdutosServicos" style=" margin-left: 0">
                    <ul class="nav nav-tabs">
                        ...
                        <li id="tabProdutos"><a href="#tab2" data-toggle="tab">Peças</a></li>
                        <li id="tabServicos"><a href="#tab3" data-toggle="tab">Mão de Obra</a></li>
                        ...
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="span12" id="divCadastrarOs">
                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span6">
                                            <label for="observacoes">Carro</label>
                                ...
                                <table class="table table-bordered" id="tblProdutos">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($produtos as $p) {
                                            ...
                                            $preco = $p->subTotal;
                                            $totalprod = $totalprod + $preco;
                                            echo '<tr>';
                                            echo '<td>'.$p->descprod.'</td>';
                                            echo '<td><span idAcao="'.$p->idProdutos_os.'" title="Excluir Produto" class="btn btn-danger"><i class="icon-remove icon-white"></i></span></td>';
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>R$ <?php echo number_format($totalprod,2,',','.');?><input type="hidden" id="total-venda" value="<?php echo number_format($totalprod,2); ?>"></strong></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
    ...
    $(".money").maskMoney(); 
     ...
     $(document).on('click', '#btn-faturar', function(event) {
       event.preventDefault();
         total_produto = $('#total-venda').val();
         total_servico = $('#total-servico').val();
         total_produto = total_produto.replace(',', '' );
     ...
     $("#produto").autocomplete({
      ...
      $("#servico").autocomplete({
            ...
            select: function( event, ui ) {
                 ...
                 $("#precoServico").val(ui.item.total);
